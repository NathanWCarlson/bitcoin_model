...
Scenario management interactions on the Home experience should follow the patterns defined in the [Scenario Persistence Controls](./scenario_persistence_controls.md) blueprint.
